...
export const enContent: SiteContent = {
  ...
  resume: {
    ...
    skills: [
      ...
      { group: 'Backend & Services', items: ['Node.js', 'NestJS', 'Java', 'Spring Boot 3', 'RESTful APIs', 'JWT', 'MongoDB', 'Redis', 'Caffeine', 'MySQL', 'Elasticsearch', 'Supabase', 'Stripe', 'Swagger/Knife4j'] },
